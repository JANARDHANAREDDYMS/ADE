...
variables does it contain?\n");
scanf("%d",&NumberOfVariable);
while(NumberOfVariable<=0)
{
printf("The number of variables should be greater than 0, please enter
again:\n\n");
printf("Please provide the information for the sum of minterms.\n\nHow
many variables does it contain?\n");
scanf("%d",&NumberOfVariable);
}
...
{
printf("The number of minterms cannot be greater than 2^%d nor smaller
than 1, please enter again:\n",NumberOfVariable);
printf("How many minterms (including Don't-Care minterms) does it
contain?\n");
scanf("%d",&NumberOfAllMinterm);
}
...
{
printf("The number of Don't-Care minterms cannot be greater than the
number of all minterms nor smaller than 0, please enter again:\n");
printf("How many Don't-Care minterms does it contain?\n");
scanf("%d",&NumberOfDontCare);
}
...
{
if(i==0)
printf("Please enter the decimal index of the 1st minterm(in
ascending order):");
else if(i==1)
printf("Please enter the decimal index of the 2nd minterm(in
ascending order):");
else if(i==2)
printf("Please enter the decimal index of the 3rd minterm(in
ascending order):");
else
printf("Please enter the decimal index of the %dth minterm(in
ascending order):",i+1);
scanf("%d",&MintermIndicesDecimal[i]);
if(i!=0 && MintermIndicesDecimal[i]<=MintermIndicesDecimal[i-1])
{
printf("The numbers are not in ascending order, please re-enter
all the indices again.\n\n");
i=-1;
}
...
{
if(i==0)
printf("Please enter the decimal index of the 1st Don't-
Care minterm (in ascending order):");
else if(i==1)
printf("Please enter the decimal index of the 2nd Don't-
Care minterm (in ascending order):");
else if(i==2)
printf("Please enter the decimal index of the 3rd Don't-
Care minterm (in ascending order):");
else
printf("Please enter the decimal index of the %dth Don't-
Care minterm (in ascending order):",i+1);
scanf("%d",&MintermIndicesDecimal_DontCare[i]);
if(i!=0 &&
MintermIndicesDecimal_DontCare[i]<=MintermIndicesDecimal_DontCare[i-1])
{
printf("The numbers are not in ascending order, please
re-enter all the indices again.\n\n");
i=-1;
}
else if(MintermIndicesDecimal[i]>=pow(2,NumberOfVariable))
{
...
for(i=0;i<NumberOfAllMinterm;i++)
{
Minterm_Binary[i][NumberOfVariable]=OneCounter(Minterm_Binary[i],NumberOfVariab
le);
